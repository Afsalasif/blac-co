  ...
  return (
    <main className="bg-black text-white min-h-screen flex flex-col justify-between">
      ...
      <section className="flex flex-col mt-10 items-center container mx-auto justify-center text-center py-20">
        <h2 className="text-6xl text-center  font-extralight font-raleway text-white hover:text-[#c08c5a] uppercase mb-12">
          CONTACT US
        </h2>
        <p className="  mb-20">Whether you're looking to buy, sell, lease, or invest in Dubai's real estate market, Blac & Co
...
can assist you with your property needs.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full mb-20 max-w-4xl">
          ...
          <div className="flex flex-col items-center">
            <Mail className="text-white hover:text-[#c08c5a] mb-2" size={40} />
          ...
          {/* Phone */}
          <div className="flex flex-col items-center">
            <Phone className="text-white hover:text-[#c08c5a] mb-2" size={40} />
          ...
          {/* Address */}
          <div className="flex flex-col items-center">
            <MapPin className="text-white hover:text-[#c08c5a] mb-2" size={40} />
