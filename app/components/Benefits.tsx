    ...
    <div className="bg-black min-h-screen flex mt-10 px-4 w-full">
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-2xl md:max-w-6xl flex flex-col gap-y-6 mx-auto">
          ...
          <p className=" font-raleway text-white  mb-6">
          ...
          <ul className="list-disc list-inside  font-raleway text-white  mb-6">
          ...
          <h2 className="text-3xl md:text-4xl  font-raleway text-metallic-bronze mb-4">
