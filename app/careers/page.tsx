    ...
    <main>
      ...
      <div className="bg-black text-white min-h-screen">
        ...
        <div className="container mx-auto py-16 px-4">
          <h1 className="text-4xl lg:text-6xl font-extralight font-raleway uppercase  mt-20 text-center mb-16">
            Be a part of our team
          </h1>

          <div className="max-w-4xl mx-auto mb-16">
            <p className="mb-6">
              Blac & CO strives to build a team of talented professionals and is
              passionate about helping them do what they love throughout their
              career here. We are always on the lookout for enthusiastic and
              driven people, offering countless prospects and professional
              growth.
            </p>

            <p>
              Blac & CO is always interested in motivated people on its team. Send
              your CV and we will contact you if we find a suitable position.
            </p>
          </div>

          {/* Form Section */}
          <div
            className="max-w-4xl mx-auto border-l-2 border-r-2 border-[#c08c5a]   p-8"
            style={{
          ...
          >
            <h2 className="text-3xl font-bold uppercase text-center mb-2">
