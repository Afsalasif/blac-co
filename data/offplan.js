const offplanProjects = [
  ...
  },
  {
    ...
    title: "Damac Islands",
    slug: "damac-islands",
    price_range: "Starting from AED  2.5 Million",
    ...
    bathrooms: "4-5",
    size_range: "2,000 - 3,200 sq. ft.",
    handover_date: "Q3 2028",
    developer: "DAMAC Properties",
    developer_slug: "damac-properties",
    cover_image: "https://i.imgur.com/kUu13Mu.jpeg",
    other_images: [
      "https://i.imgur.com/m4dBkU8.jpeg",
      "https://i.imgur.com/7nV6DBu.jpeg",
      "https://i.imgur.com/w50rPi2.jpeg",
      "https://i.imgur.com/gOXatci.jpeg",
      "https://i.imgur.com/0wySBnK.jpeg",
      "https://i.imgur.com/3PNAbFB.png",
      "https://i.imgur.com/vGxq7mn.jpeg",
      "https://i.imgur.com/rKuT16O.jpeg",
    ],
    description:
      "Damac Islands is an exclusive luxury waterfront development by DAMAC Properties, strategically situated in the heart of Dubailand, Dubai. This high-end residential community is designed to offer a perfect blend of modern architecture, premium living spaces, and eco-friendly features. The development boasts a collection of 4, 5, 6, and 7-bedroom villas and townhouses, all of which are designed with contemporary layouts that prioritize both comfort and functionality. Residents of Damac Islands enjoy panoramic waterfront views, private beach access, and luxurious living, with spacious properties designed to offer the utmost privacy and relaxation. The community is thoughtfully designed to promote sustainable living, with green spaces, landscaped parks, and energy-efficient construction techniques that minimize environmental impact. Among its world-class amenities, Damac Islands features a wide range of facilities, including state-of-the-art fitness centers, swimming pools, recreational areas, and a private beach for residents to enjoy. Whether you’re looking to unwind in the natural surroundings, stay fit, or indulge in leisure activities, the development offers all the resources needed for a balanced lifestyle. In addition to its premium residences and amenities, Damac Islands is conveniently located with easy access to major business and lifestyle destinations in Dubai. Key areas such as Dubai Investments Park, Dubai Sports City, and other commercial hubs are just a short drive away, making it an ideal location for both work and play. With competitive pricing starting from AED 1.5 million for townhouses, the community provides a more accessible alternative to other prestigious island projects in Dubai, without compromising on luxury or quality. Overall, Damac Islands offers a unique opportunity for those seeking a sophisticated yet tranquil living environment in Dubai, combining luxury, convenience, and sustainability in one remarkable development.",
    features: [
      "Central Hub",
      "Fountain",
      "Lagoon Tour",
      ...
      "Hot Springs",
      "SPA",
      "Iguanas Park & Fruit Market",
      "Tortoise Garden",
      "Jungle Swings",
      "Private Boat Rides",
    ],
    building_highlights: [
      "Maldives Island: Overwater villas, Private lagoons, Tropical landscaping",
      "Bali Island: Tranquil gardens, Water features, Traditional Balinese architecture",
      "Hawaii Island: Tropical-inspired residences, Surf-friendly beaches, Abundant greenery",
      "Bora Bora Island: Crystal-clear lagoons, Floating cabanas, Beachfront residences",
      "Fiji Island: Private beach access, Island-themed landscaping, Spacious residences",
      "Seychelles Island: Nature-inspired architecture, Panoramic views, World-class amenities",
      "Townhouses: 4- and 5-bedroom units starting at AED 2.25 million, Modern designs, private balconies, and pools",
      "Villas: 6- and 7-bedroom villas up to 17,079 sq. ft., Gyms, maid’s quarters, state-of-the-art amenities",
      "Aqua Dome: Water attraction with slides, pools, and relaxation areas",
      "Adventure Activities: Kayaking, Paddleboarding, Ziplining, Jungle rivers",
      "Tranquil Escapes: Hammocks by the lagoon, Hot spring spa, Crystal-clear lagoon",
      "Location Benefits: 23 minutes to Al Maktoum International Airport, 30 minutes to Burj Al Arab, 28 minutes to Dubai International Airport, 15-18 minutes to Dubai Investment Park and Dubai Sports City",
    ],
    payment_plan: {
      on_booking: {
        percentage: 25,
    ...
    attractions_nearby: [
      "Global Village: A seasonal multicultural park that combines entertainment, shopping, and dining experiences from around the world. It features pavilions from different countries, live performances, food stalls, and family activities",
      "The Tiger Woods Dubai: A luxurious golf course designed by Tiger Woods, located within the Dubailand community. It offers a world-class golfing experience.",
      "Al Marmoom Desert Conservation Reserve: Located on the outskirts of Dubailand, this conservation area is a protected desert environment where you can explore the beauty of the UAE's natural landscapes and wildlife.",
      "IMG Worlds of Adventure: An indoor theme park with five themed zones, including Marvel, Cartoon Network, Lost Valley (dinosaurs), and more. It features a variety of thrilling rides and attractions.",
      "TGlobal Village: A seasonal multicultural park that combines entertainment, shopping, and dining experiences from around the world. It features pavilions from different countries, live performances, food stalls, and family activities.",
    ],
    schools_nearby: [
      "GEMS Wellington Primary School",
      "Jumeirah International Nursery",
